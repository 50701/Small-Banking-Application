...
<form class="card" action="{{ route('transfer') }}" method="post">
    @csrf
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div>
                <input type="email" class="form-control" placeholder="Enter email" id="email" name="recipient_email" value="{{ old('recipient_email') }}" required>
            </div>
        </div>
        <div class="mb-3">
            <label class="form-label amount required">Amount</label>
            <div>
                <input type="number" class="form-control" placeholder="Enter amount to transfer" id="amount" name="amount" min="1" value="{{ old('amount') }}" required>
            </div>
        </div>
        <div>
