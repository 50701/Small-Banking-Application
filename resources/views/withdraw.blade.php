...
<form class="card" action="{{ route('withdraw') }}" method="post">
    @csrf
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div>
                <input type="number" class="form-control" placeholder="Enter amount to withdraw" id="amount" name="amount" min="1" value="{{ old('amount') }}" required>
            </div>
        </div>
        <div>
